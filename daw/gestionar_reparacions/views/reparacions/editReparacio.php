...
$_SESSION["rep"] = $serviceRep->getReparationById($_GET["id"]);
?>
<!doctype html>
<html lang="en">
<head>
...
<form action="../../controller/reparacions/addorEditReparacioController.php"
    ...
    <div class="col-12">
        <h1 style="color: #62A5A2">Edita Reparació</h1>
    </div>

    <?php
    if (isset($_GET["id"])) {
        ?>
        <input type="hidden" class="form-control" name="idRep" value="<?php echo $_GET["id"] ?>">
        <?php
    }
    ?>
    ...
    <div class="col-md-6 mt-3">
        ...
        <input type="text" class="form-control  " id="inputLastName" name="nomCli"   value="<?php echo $_SESSION["rep"]->getNomClient() ?? '' ?>">
        <?php
    ...
    <div class="col-md-6 mt-3">
        ...
        <input type="number" class="form-control  " id="inputLastName" name="telCli"
               value="<?php echo $_SESSION["rep"]->getTelClient() ?? '' ?>">
        <?php
    ...
    <div class="col-md-6 mt-3">
        ...
        <input type="text" class="form-control " id="inputAddress" name="tipus"
               value="<?php echo $_SESSION["rep"]->getDispositiu() ?? '' ?>">
        <?php
    ...
    <div class="col-md-6 mt-3">
        ...
        <input type="date" class="form-control " id="inputAddress" name="data"
               value="<?php echo $_SESSION["rep"]->getDescReparacio() ?? '' ?>">
        <?php
    ...
    <div class="col-12 mt-3">
        ...
        <input rows="6" class="form-control" id="inputBodyVisit" name="descRep"
                  value="<?php echo $_SESSION["rep"]->getDescReparacio() ?? '' ?>">
        <?php
    ...
    <div class="col-12 mt-3">
        ...
        <label for="inputFirstName" class="form-label">Estat:</label>
        <input type="text" class="form-control  " id="inputLastName" name="estat"
               value="<?php echo $_SESSION["rep"]->getEstatRep() ?? '' ?>">
        <?php
    ...
    <div class="col-12 mt-3">
        ...
        <a href="inici.php" ><input type="button" class="btn btn-primary" value="Cancel"></a>
    </div>
